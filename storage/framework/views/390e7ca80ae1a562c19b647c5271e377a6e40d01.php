...
<body id="page-top">
 ...
 <div class="container">
    ...
    <link rel="stylesheet" href="<?php echo e(asset('js/css.css')); ?>">
            ...
            <table class="table table-striped">
                ...
                <?php foreach($entrada as $ent): ?>
                    <tr>
                        ...
                        <td><a class="btn btn-primary" href="<?php echo e(route('buscre',$ent->idv)); ?>">Ver reporte</a> </td>
                    </tr>
        ...
        <script type="text/javascript">
            $(document).ready(function () {
                $('#fecha').on('change',function () {
                    $("#tablas").load('<?php echo e(url('criterioreporte')); ?>' + '?' + $(this).closest('form').serialize());
