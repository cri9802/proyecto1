...
<div class="container">
  <div class="row">
    <div class="slide_uno col-md-12 col-sm-12 col-xs-12">
      <h2 class="text-center">Reporte Ventas</h2>
      <div class="clearfix"></div>

             <a href="http://localhost:8888/kikosfood/principal" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"><i class="fas fa-download fa-sm text-white-50"></i> Menu Principal</a>
<br>
      ...
      <table class="table table-striped table-bordered">
        ...
        <div class="row">
          ...
          <tr>
            ...
            <th width="30">Nombre Mesero</th>
            <th width="30">Nombre de Cliente </th>
